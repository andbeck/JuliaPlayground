...
function random_adbm_parameters(S)
    ...
    return (S = S, M = sort(M), e = rand(e_cst), a = 10^(rand(ar_cst)), ai = rand(ar_expi), aj = rand(ar_expj), Ea = rand(Ea), b = rand(ht_threshold), h = rand(ht_cst), hi = rand(ht_expi), hj = rand(ht_expj), Eh = rand(Eh), n = n_cst, ni = rand(n_expi))
end
...
function informed_adbm_parameters(S)
    ...
    return (S = S, M = sort(M), a = exp(rand(ar_cst)), ai = rand(ar_expi), aj = rand(ar_expj), Ea = rand(Ea), b = rand(ht_threshold), h = exp(rand(ht_cst)), hi = ht_expi, hj = ht_expj, Eh = rand(Eh), n = n_cst, ni = rand(n_expi), e = rand(e_cst), ei = e_expi)
end
